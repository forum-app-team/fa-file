...
For comprehensive API testing, use the Postman collection available in the [fa-api-collection](https://github.com/forum-app-team/fa-api-collection) repository.
